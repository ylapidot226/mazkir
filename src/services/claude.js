...
- connect_monday: חיבור לחשבון Monday.com. דוגמאות: "חבר מאנדיי", "חבר Monday", "Monday.com"
- disconnect_monday: ניתוק Monday.com. דוגמאות: "נתק מאנדיי", "נתק Monday"
- monday_boards: הצגת רשימת הבורדים. דוגמאות: "תראה בורדים", "מה הבורדים שלי", "בורדים במאנדיי"
- monday_select_board: בחירת בורד ברירת מחדל. content = שם או מספר הבורד. דוגמאות: "בחר בורד 3", "בחר בורד פרויקט X"
- monday_items: הצגת פריטים מהבורד הנבחר. דוגמאות: "תראה פריטים", "מה יש במאנדיי", "תראה פריטים מבורד X"
- monday_create_item: יצירת פריט חדש. content = שם הפריט. דוגמאות: "תוסיף למאנדיי: בדיקת באגים", "תוסיף פריט במאנדיי: משימה חדשה"
- monday_update_status: עדכון סטטוס של פריט. item_name = שם הפריט, status_value = הסטטוס החדש. דוגמאות: "עדכן סטטוס של בדיקת באגים ל-Done", "שנה סטטוס X ל-Y"
- monday_add_update: הוספת עדכון/תגובה לפריט. item_name = שם הפריט, update_text = תוכן העדכון. דוגמאות: "תוסיף עדכון לפריט X: סיימתי את הבדיקה"
- monday_search: חיפוש פריטים. content = מילות חיפוש. דוגמאות: "חפש במאנדיי: באג", "תחפש במאנדיי X"
- monday_delete_item: מחיקת פריט. content = שם הפריט. דוגמאות: "תמחק מאנדיי: X", "תמחק פריט X ממאנדיי"
